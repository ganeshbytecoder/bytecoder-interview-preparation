...
**💡 Key Insight:** Use BFS to color nodes with alternating colors. If neighbor has same color, not bipartite.
...
🔹 **Type:** Graph, DFS/BFS🔹 **Concept:** A bipartite graph is a special case of **M-Coloring** where M = 2.🔹 **Approach:**
...
🔹 **Type:** Graph, DFS/BFS🔹 **Concept:** This is a **2-coloring problem** where you check if it's possible to divide people into two groups based on dislikes.🔹 **Approach:**
...
🔹 **Type:** Graph, Bitmask DP🔹 **Concept:** This is related to graph coloring in the sense that each node needs to be visited in a specific order.🔹 **Approach:**
...
🔹 **Type:** DP, Bitmasking, Backtracking🔹 **Concept:** Similar to **M-Coloring**, where valid students need to be placed in a classroom based on given constraints.🔹 **Approach:**
...
🔹 **Type:** Backtracking🔹 **Concept:** Similar to **M-Coloring**, where you make decisions at each step and backtrack when necessary.🔹 **Approach:**
