...
//        return pair;
    ...
    public  static  void CheckString(StringBuffer strings){
        strings.append("ganesh");
        strings = new StringBuffer();
        strings.append("Singh");
...
//        }
    ...
    public static void main(String[] args) {
        ...
        CheckString(stringBuffer);
        System.out.println(stringBuffer);


        Map<MyMap, String > map = new HashMap<>();
        map.put(new MyMap(), "1");
        map.put(new MyMap(), "2");
        map.put(new MyMap(), "3");
        map.put(new MyMap(), "4");

        System.out.println(new MyMap().equals(new MyMap()));
        System.out.println(new MyMap() == new MyMap());
